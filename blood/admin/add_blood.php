...
<html lang="en">
  ...
  <body>
    ...
    <div class="vertical-nav bg-red" id="sidebar">
        ...
        <p class="text-black font-weight-bold text-uppercase px-3 small pb-4 mb-0 text-white"> Add Blood</p>
    ...
    <div class="page-content parallax" id="content">
        ...
        <div class="col-6 pd-form">
            <form action="" method="post">
                ...
                <button class="btn btn-success" name="add"> Add Blood</button>  
            </form>
        </div>
        </div>
    </div>
...
<?php
    if(isset($_POST['add'])){
        ...
        $query = "insert into store values('$_POST[b_id]', '$_POST[b_g]', '$_POST[date]')";
